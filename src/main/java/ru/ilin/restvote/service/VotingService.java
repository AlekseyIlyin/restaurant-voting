...
import ru.ilin.restvote.repository.datajpa.CrudVoteRepository;
...
public class VotingService {
    ...
    @Autowired
    public VotingService(CrudVoteRepository repository, RestaurantService restaurantService, UserService userService) {
    ...
    public void save(int restaurantId, LocalDateTime dateTime, int userId) {
        saveVote(new Vote(restaurantService.get(restaurantId), userService.get(userId), dateTime));
    }
}
